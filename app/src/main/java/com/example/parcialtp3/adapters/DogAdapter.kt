...
class DogAdapter(
    ...
    private var favoriteChangedListener: OnFavoriteChangedListener? = null

    fun setOnFavoriteChangedListener(listener: OnFavoriteChangedListener) {
        favoriteChangedListener = listener
    }
